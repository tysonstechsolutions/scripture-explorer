...
export const STORY_CHAPTERS: StoryChapter[] = [
  {
    ...
    glossaryTerms: [
      'BCE', 'CE', 'Mesopotamia', 'Sumerians', 'Ziggurat', 'Cuneiform',
      'Torah', 'Big Bang', 'Polytheism', 'Monotheism', 'Table of Nations',
      'Nimrod', 'Mizraim', 'YHWH', 'Enuma Elish', 'Zoroastrianism'
    ],
    timeline: [
      { date: '~13.8 Billion Years Ago', event: 'The Big Bang — the universe begins', approximate: true },
      { date: '~4.6 Billion Years Ago', event: 'Earth forms from cosmic debris', approximate: true },
      { date: 'Beginning', event: 'God creates the heavens and earth (Genesis 1)', approximate: true },
      { date: 'The Fall', event: 'Adam and Eve expelled from Eden', approximate: true },
      { date: 'Cain and Abel', event: 'The first murder — brother kills brother', approximate: true },
      { date: 'Noah', event: 'The Flood and God\'s covenant with humanity', approximate: true },
      { date: 'Table of Nations', event: 'Noah\'s sons spread — Nimrod founds Babylon, Mizraim becomes Egypt', approximate: true },
      { date: 'Tower of Babel', event: 'Languages confused, peoples scattered', approximate: true },
